...
You can play around with a few example components here. However, for a much richer set of components with much more functionality, check out the [Ocelot design system by davezuch](https://davezuch.github.io/purescript-ocelot/#typeaheads).
...
Curious how to build a dropdown with `Select`? Check out [the dropdown tutorial](https://davezuch.github.io/purescript-halogen-select/tutorials/dropdown).
...
The typeahead below is quite simple; to see examples of more sophisticated typeaheads -- including ones that fetch and display data asynchronously -- check out the [Ocelot component library](https://davezuch.github.io/purescript-ocelot/#typeaheads).

<div data-component="typeahead"></div>

Curious how to build a typeahead with `Select`? Check out [the typeahead tutorial](https://davezuch.github.io/purescript-halogen-select/tutorials/typeahead).
